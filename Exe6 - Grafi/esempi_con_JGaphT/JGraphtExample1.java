...
public class JGraphtExample1 {
	public static void main(String[] args) { 
		//Creo un grafo orientato, DefaultEdge senza peso (maggiornaza delle volte)
		...
		for (String s : vertici) { 
			System.out.print(s + ":"); 
			//SuccessorListOf restituisce una lista
			//	vedi: https://jgrapht.org/javadoc/org.jgrapht.core/org/jgrapht/Graphs.html
