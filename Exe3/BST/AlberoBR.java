...
public class AlberoBR extends AlberoBinarioImpl implements Dizionario{
	...
	*/
	...
	public NodoBinario suc(NodoBinario u) {
		NodoBinario r = null;
		if(u.destro != null) {
			r = min(u.destro);
			return r;
		}
		while(u.padre != null && u.padre.destro.equals(u)) {
			u = u.padre;
		}
		return r;
	}
	...
	/**
	 * Crea albero rappresentante due l'intersezione dei due alberi
	 * @param u Albero Binaro
	 * @param v Albero Binaro
	 */
